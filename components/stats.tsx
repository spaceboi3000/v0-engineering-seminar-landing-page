...
const STATS = [
  { label: "Participants", value: 250, big: true },
  { label: "Sponsors", value: 7, big: false },
  { label: "Speakers", value: 7, big: false },
  { label: "Company Representatives", value: 15, big: false },
]
...
function StatItem({ stat, visible, index }: { stat: typeof STATS[number]; visible: boolean; index: number }) {
